...
function AddChild({ nestedIn = "", setOperation, updatedValue }: AddChildProps) {
    const { menuOf, newFiles, setNewFiles, setUpdatedComponents, updatedComponents, uniqueFileName, setUniqueFileName, pages } = useStore();
    ...
    const handleAdd = () => {
        ...
        const TempupdatedComponents = tempUpdateFunc()

        setUpdatedComponents(TempupdatedComponents)
        setUniqueFileName()
        setOperation("")
    }
