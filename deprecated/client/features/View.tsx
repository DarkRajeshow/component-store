...
function View({ generatePDF, reference, zoom, setZoom, offset, setOffset, selectionBox }) {
    const { components, design, loading, setSelectionBox, fileVersion, baseDrawing, selectedPage, setSelectedPage, pages, generateStructure, fetchProject, rotation, setRotation } = useStore();
    ...
    const filePaths = useMemo(() => {
        const paths = Object.values(components)
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            />}
                            {components && Object.entries(components).map(([attribute, value]) => {
